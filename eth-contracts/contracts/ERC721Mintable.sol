...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(_owner == msg.sender, "Address is not owner");
        _;
    }
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != tokenOwner, "Token already belongs to owner");
        require(
            msg.sender == tokenOwner ||
                isApprovedForAll(tokenOwner, msg.sender),
            "Address is not authorised"
        );
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function _setTokenURI(uint256 tokenId) internal {
        ...
        string memory generatedTokenId = uint2str(tokenId);
        _tokenURIs[tokenId] = strConcat(_baseTokenURI, generatedTokenId);
    }
}
